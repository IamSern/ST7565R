...
/*
	...
	* @param	( параметры ):	1 byte; 0х00 = Black, 0хFF = White,
...
/*
	******************************************************************************
	* @brief	 ( описание ):  turn display on/off ( enabled by default )
...
/*
	******************************************************************************
	* @brief	 ( описание ):  draws a monochrome picture
	* @param	( параметры ):
	* @return  ( возвращает ):	
...
/*
	******************************************************************************
	* @brief	 ( описание ): outputs 1 character
	* @param	( параметры ):	X Y coordinates, symbol, font, multiplier, color 1 or 0
	* @return  ( возвращает ):	
...
/*
	******************************************************************************
	* @brief	 ( описание ):  writes a string
	* @param	( параметры ):	X Y coordinates, string, font, multiplier, color 1 or 0
	* @return  ( возвращает ):	
	******************************************************************************
*/
